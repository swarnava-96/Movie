...
For the sentiment analysis, I have used the reviews dataset and text preprocessing was done using Tf-idf(countvectorizer) after removing the stop words and for the model building I have used Multinomial Naive Bayes.
